...
/// The bottom sheet reads the LanguageProvider from its own context
/// (which inherits the provider from the app's widget tree via the overlay).
...
class _LanguagePickerSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Use Consumer to properly listen to LanguageProvider changes
    // within the bottom sheet's own widget tree.
